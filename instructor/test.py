import pandas as pd
import numpy as np
attack = pd.read_csv("data/adult_with_pii.csv")
attack = attack.drop(0)
print(attack.describe())
# print(attack.describe() )
adult = pd.read_csv('data/newAdult.csv')
...
res = pd.concat([name,ssn, age, sex, native_country], axis = 1)
link_attack = res[10000:20000]
# print(link_attack.head())
# print(link_attack.describe())
link_attack.to_csv('data/link_attack.csv', index = False)
